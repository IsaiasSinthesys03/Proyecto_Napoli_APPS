-- ========================================
-- CREAR PEDIDO DE PRUEBA PARA COURIERAPP
-- ========================================
-- Restaurant: 06a5284c-0ef8-4efe-a882-ce1fc8319452
-- Customer: josegaspar (4d23b895-5ba2-4cd4-ad80-7dd96376f671)
-- Product: Pizza (7978c1c9-467e-46f9-ac27-e8e3321244f9)
-- ========================================
...
SELECT 
  ...
  address_snapshot->>'street' as address,
  total_cents
FROM orders
...
SELECT get_available_orders('06a5284c-0ef8-4efe-a882-ce1fc8319452');
