...
/// Paleta de colores de Napoli Pizzeria - Drivers App
/// Basada en la identidad visual de Barrio Napoli
class AppColors {
  // ============================================
  ...
  // ============================================
  // COLORES ESPECÍFICOS PARA DRIVERS APP
  // ============================================

  /// Verde brillante para estado "En Línea" (#00E676)
  static const Color onlineGreen = Color(0xFF00E676);

  /// Gris para estado "Desconectado" (#9E9E9E)
  static const Color offlineGray = Color(0xFF9E9E9E);

  /// Azul para navegación (#2196F3)
